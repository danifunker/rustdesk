...
pub struct LoginRequest {
    ...
    pub my_platform: ::std::string::String,
    // message oneof groups
...
impl LoginRequest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "my_platform",
            |m: &LoginRequest| { &m.my_platform },
            |m: &mut LoginRequest| { &mut m.my_platform },
        ));
...
impl ::protobuf::Message for LoginRequest {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                13 => {
                    ...
                    self.my_platform = is.read_string()?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.my_platform.is_empty() {
            my_size += ::protobuf::rt::string_size(13, &self.my_platform);
        }
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.my_platform.is_empty() {
            os.write_string(13, &self.my_platform)?;
        }
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
                &login_request::Union::file_transfer(ref v) => {
    ...
    fn default_instance() -> &'static LoginRequest {
        static instance: LoginRequest = LoginRequest {
            ...
            my_platform: ::std::string::String::new(),
            union: ::std::option::Option::None,
            unknown_fields: ::protobuf::UnknownFields::new(),
            cached_size: ::protobuf::rt::CachedSize::new(),
        };
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bportForwardB\0\x12\x1a\n\x07version\x18\x0b\x20\x01(\tR\x07versionB\
    \0\x12!\n\x0bmy_platform\x18\r\x20\x01(\tR\nmyPlatformB\0B\t\n\x05union\
    \x12\0:\0\"%\n\x0bChatMessage\x12\x14\n\x04text\x18\x01\x20\x01(\tR\x04t\
    extB\0:\0\"\x80\x02\n\x08PeerInfo\x12\x1c\n\x08username\x18\x01\x20\x01(\
    \tR\x08usernameB\0\x12\x1c\n\x08hostname\x18\x02\x20\x01(\tR\x08hostname\
    B\0\x12\x1c\n\x08platform\x18\x03\x20\x01(\tR\x08platformB\0\x12.\n\x08d\
    isplays\x18\x04\x20\x03(\x0b2\x10.hbb.DisplayInfoR\x08displaysB\0\x12)\n\
    ...
    \x0f.hbb.ControlKeyR\tmodifiersB\0\x12'\n\x04mode\x18\t\x20\x01(\x0e2\
    \x11.hbb.KeyboardModeR\x04modeB\0B\t\n\x05union\x12\0:\0\"\x98\x01\n\nCu\
    rsorData\x12\x10\n\x02id\x18\x01\x20\x01(\x04R\x02idB\0\x12\x14\n\x04hot\
    x\x18\x02\x20\x01(\x11R\x04hotxB\0\x12\x14\n\x04hoty\x18\x03\x20\x01(\
    ...
    altB\0\x12\x1e\n\tchallenge\x18\x02\x20\x01(\tR\tchallengeB\0:\0\"\xce\
    \x01\n\tClipboard\x12\x1c\n\x08compress\x18\x01\x20\x01(\x08R\x08compres\
    sB\0\x12\x1a\n\x07content\x18\x02\x20\x01(\x0cR\x07contentB\0\x12\x16\n\
    \x05width\x18\x03\x20\x01(\x05R\x05widthB\0\x12\x18\n\x06height\x18\x04\
    \x20\x01(\x05R\x06heightB\0\x12.\n\x06format\x18\x05\x20\x01(\x0e2\x14.h\
    bb.ClipboardFormatR\x06formatB\0\x12#\n\x0cspecial_name\x18\x06\x20\x01(\
    \tR\x0bspecialNameB\0:\0\"E\n\x0fMultiClipboards\x120\n\nclipboards\x18\
    \x01\x20\x03(\x0b2\x0e.hbb.ClipboardR\nclipboardsB\0:\0\"\xaf\x01\n\tFil\
    eEntry\x12.\n\nentry_type\x18\x01\x20\x01(\x0e2\r.hbb.FileTypeR\tentryTy\
    peB\0\x12\x14\n\x04name\x18\x02\x20\x01(\tR\x04nameB\0\x12\x1d\n\tis_hid\
    den\x18\x03\x20\x01(\x08R\x08isHiddenB\0\x12\x14\n\x04size\x18\x04\x20\
    ...
    \x12\x14\n\x04path\x18\x02\x20\x01(\tR\x04pathB\0:\0\"\x7f\n\rSwitchDisp\
    ...
    \x06height\x18\x05\x20\x01(\x05R\x06heightB\0:\0\"a\n\x0ePermissionInfo\
    \x121\n\npermission\x18\x01\x20\x01(\x0e2\x0f.hbb.PermissionR\npermissio\
    nB\0\x12\x1a\n\x07enabled\x18\x02\x20\x01(\x08R\x07enabledB\0:\0\"\xea\
    \x03\n\rOptionMessage\x128\n\rimage_quality\x18\x01\x20\x01(\x0e2\x11.hb\
    b.ImageQualityR\x0cimageQualityB\0\x12F\n\x16lock_after_session_end\x18\
    \x02\x20\x01(\x0e2\x0f.hbb.BoolOptionR\x13lockAfterSessionEndB\0\x12?\n\
    \x12show_remote_cursor\x18\x03\x20\x01(\x0e2\x0f.hbb.BoolOptionR\x10show\
    RemoteCursorB\0\x124\n\x0cprivacy_mode\x18\x04\x20\x01(\x0e2\x0f.hbb.Boo\
    lOptionR\x0bprivacyModeB\0\x122\n\x0bblock_input\x18\x05\x20\x01(\x0e2\
    \x0f.hbb.BoolOptionR\nblockInputB\0\x122\n\x14custom_image_quality\x18\
    \x06\x20\x01(\x05R\x12customImageQualityB\0\x126\n\rdisable_audio\x18\
    \x07\x20\x01(\x0e2\x0f.hbb.BoolOptionR\x0cdisableAudioB\0\x12>\n\x11disa\
    ble_clipboard\x18\x08\x20\x01(\x0e2\x0f.hbb.BoolOptionR\x10disableClipbo\
    ardB\0:\0\"F\n\tTestDelay\x12\x14\n\x04time\x18\x01\x20\x01(\x03R\x04tim\
