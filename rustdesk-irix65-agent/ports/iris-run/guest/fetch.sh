...
cd /tmp
for f in r-deskvint-irix r-deskvint-irix-gui xpoke testpeer perfprobe perfprobe-stock perfprobe-nocopy pipeline capture-selftest portable-selftest; do
...
ls -l /tmp/r-deskvint-irix /tmp/testpeer /tmp/perfprobe
